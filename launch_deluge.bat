...
:Menu
cls
title Portable Deluge Launcher - Helper Edition - Main Menu
echo !NAG!
...
echo d. check for new deluge version [automatically check for a new version]
...
:2
:LaunchDeluge
if not exist ".\bin\deluge\deluge.exe" set "nag=PLEASE INSTALL DELUGE FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo DELUGE IS RUNNING
start .\bin\deluge\deluge.exe
exit
...
cls
title Portable Deluge Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Deluge Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Deluge Launcher - Helper Edition - Download Suite
...
title Portable Deluge Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo start .\bin\deluge\deluge.exe>>!quick_launcher!
...
call :HelperDownload "https://ftp.osuosl.org/pub/deluge/windows/?C=M;O=D" "index.html"
for /f tokens^=8delims^=^" %%A in (
  'findstr /i /c:".exe" "index.html@C=M;O=D"'
) Do > .\doc\deluge_link.txt Echo:%%A& goto :continue
:continue
if exist "index.html@C=M;O=D" del "index.html@C=M;O=D" >nul
...
if exist ".\extra\!deluge_exe!" (
  echo deluge is updated.
  pause
  exit /b
)
if exist "!deluge_exe!" del "!deluge_exe!" >nul
call :HelperDownload "!deluge_link!" "!deluge_exe!"
:MoveDeluge
move "!deluge_exe!" ".\extra\!deluge_exe!"
:ExtractDeluge
call :HelperExtract7Zip "!folder!\extra\!deluge_exe!" "!folder!\bin\deluge\"
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\!deluge_exe!")
exit /b 2

:e
title Portable Deluge Launcher - Helper Edition - Text-Reader Update Check
cls
...
if not exist ".\bin\deluge\deluge.exe" set nag=DELUGE IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Deluge Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Deluge Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Deluge Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Deluge Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Deluge Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Deluge Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver

...
:Menu
cls
title Portable RPCS3 Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall rpcs3 [will remove rpcs3 entirely]
echo 2. launch rpcs3 [launches rpcs3]
echo 3. reset rpcs3 [will remove everything rpcs3 except the binary]
echo 4. uninstall rpcs3 [doesn't do everything you need it to do?]
...
:2
:LaunchRPCS3
if not exist ".\bin\rpcs3\rpcs3.exe" set "nag=PLEASE INSTALL RPCS3 FIRST" & exit /b 2
title DO NOT CLOSE
cls
...
if exist .\bin\rpcs3\ rmdir /s /q .\bin\rpcs3\
if exist .\extra\rpcs3* del .\extra\rpcs3* >nul
exit /b 2
...
cls
title Portable RPCS3 Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable RPCS3 Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable RPCS3 Launcher - Helper Edition - Download Suite
...
title Portable RPCS3 Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo start "" ".\bin\rpcs3\rpcs3.exe">>!quick_launcher!
...
echo ================================================== >> !license!
cls
title Portable RPCS3 Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable RPCS3 Launcher - Helper Edition - Latest Build :D
...
:PreviewBuild
cls
title Portable RPCS3 Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable RPCS3 Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver

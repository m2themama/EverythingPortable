...
:2
:LaunchPPSSPP
if not exist ".\bin\ppsspp\PPSSPPWindows!arch!.exe" set "nag=PLEASE INSTALL PPSSPP FIRST" & exit /b 2
title DO NOT CLOSE
cls
...
REM echo set "UserProfile=%%folder%%\data\Users\MarioMasta64">>!quick_launcher!
...
echo          if %%%%d equ Removable (>>!quick_launcher!
echo            if exist "%%%%c\pspemu\PSP\" echo %%%%cpspemu\^> .\bin\ppsspp\installed.txt>>!quick_launcher!
echo             if exist "%%%%c\PSP\" echo %%%%c^> .\bin\ppsspp\installed.txt>>!quick_launcher!
echo          )>>!quick_launcher!
echo       )>>!quick_launcher!
echo    )>>!quick_launcher!
echo )>>!quick_launcher!
echo if exist .\bin\ppsspp\installed.txt goto :launch>>!quick_launcher!
echo.>>!quick_launcher!
echo :default>>!quick_launcher!
echo echo %%folder%%\data\ppsspp^> .\bin\ppsspp\installed.txt>>!quick_launcher!
echo goto launch>>!quick_launcher!
echo.>>!quick_launcher!
...
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\!ppsspp_zip!")
exit /b 2

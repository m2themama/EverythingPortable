...
:Menu
cls
title Portable ShareX Launcher - Helper Edition - Main Menu
echo !NAG!
...
echo d. check for new sharex version [automatically check for a new version]
...
cls
taskkill /f /im ShareX.exe
for /d %%i in (".\bin\sharex\*") do rmdir /s /q "%%i"
...
cls
title Portable ShareX Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable ShareX Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable ShareX Launcher - Helper Edition - Download Suite
...
title Portable ShareX Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo start .\bin\sharex\ShareX.exe>>!quick_launcher!
...
echo ================================================== >> !license!
cls
title Portable ShareX Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable ShareX Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable ShareX Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable ShareX Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable ShareX Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable ShareX Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver

...
:Menu
cls
title Portable Opera GX Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall opera gx [will remove opera gx entirely]
echo 2. launch opera gx [launches opera]
echo 3. reset opera gx [will remove everything opera gx except the binary]
echo 4. uninstall opera gx [WTF IS A GAMING BROWSER?]
...
echo d. check for new opera gx version [automatically check for a new version]
...
cls
title Portable Opera GX Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Opera GX Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Opera GX Launcher - Helper Edition - Download Suite
...
title Portable Opera GX Launcher - Helper Edition - Quicklauncher Writer
...
:e
title Portable Opera GX Launcher - Helper Edition - Text-Reader Update Check
cls
...
echo ================================================== >> !license!
cls
title Portable Opera GX Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Opera GX Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Opera GX Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Opera GX Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Opera GX Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Opera GX Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver

...
:Menu
cls
title Portable Github Desktop Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall github desktop [will remove github desktop entirely]
echo 2. launch github desktop [launches github desktop]
echo 3. reset github desktop [will remove everything github desktop except the binary]
echo 4. uninstall github desktop [prefer the web client?]
...
:1
:ReinstallGitHubDesktop
cls
call :UninstallGitHubDesktop
call :UpgradeGitHubDesktop
exit /b 2

:2
:LaunchGitHubDesktop
if not exist ".\bin\github_desktop\GitHubDesktop.exe" set "nag=PLEASE INSTALL GITHUB DESKTOP FIRST" & exit /b 2
title DO NOT CLOSE
cls
...
cls
title Portable Github Desktop Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Github Desktop Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Github Desktop Launcher - Helper Edition - Download Suite
...
title Portable Github Desktop Launcher - Helper Edition - Quicklauncher Writer
...
call :HelperDownload "https://central.github.com/deployments/desktop/desktop/latest/win32" "win32"
:MoveGitHubDesktop
move win32 .\extra\GitHubDesktopSetup.exe
:ExtractGitHubDesktop
call :HelperExtract7Zip "!folder!\extra\GitHubDesktopSetup.exe" "!folder!\temp\"
:ExtractGitHubDesktopNupkg
for %%d in ("!folder!\temp\GitHubDesktop*.nupkg") do set github_desktop_nupkg=%%d
...
echo ================================================== >> !license!
cls
title Portable Github Desktop Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Github Desktop Launcher - Helper Edition - Latest Build :D
...
:PreviewBuild
cls
title Portable Github Desktop Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Github Desktop Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
...
if exist ".\data\github_desktop\" xcopy ".\data\github_desktop\*" ".\data\Users\MarioMasta64\" /e /i /y & rmdir /s /q ".\data\github_desktop\"
exit /b 2
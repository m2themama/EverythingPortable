...
:Menu
cls
title Portable Ryujinx Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall ryujinx [will remove ryujinx entirely]
echo 2. launch ryujinx [launches ryujinx]
echo 3. reset ryujinx [will remove everything ryujinx except the binary]
echo 4. uninstall ryujinx [pc too underpowered for ryujinx?]
...
cls
title Portable Ryujinx Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Ryujinx Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Ryujinx Launcher - Helper Edition - Download Suite
...
title Portable Ryujinx Launcher - Helper Edition - Quicklauncher Writer
...
for /f tokens^=%counter%delims^=^" %%A in (
  'findstr /i /c:"/Ryujinx/release-channel-master/releases/download/" index.html'
) Do > .\doc\ryujinx_link.txt Echo:%%A
set /p ryujinx_link=<.\doc\ryujinx_link.txt
if "!Debug!" EQU "1" (
  echo !ryujinx_link!
  echo !counter!
)
set "tempstr=!ryujinx_link!"
set "result=%tempstr:/=" & set "result=%"
set "ryujinx_zip=!result!"
if "!ryujinx_zip:~-12!"=="-win_x64.zip" ( if "!Debug!" EQU "1" ( echo hit ) ) & goto ExitUpgradeSearchLoop
goto UpgradeSearchLoop
:ExitUpgradeSearchLoop
if exist index.html del index.html >nul
cls
set "ryujinx_link=https://github.com!ryujinx_link:.tar.gz=.zip!"
set "ryujinx_link=!ryujinx_link:-headless-sdl2=!"
set "tempstr=!ryujinx_link!"
set "result=%tempstr:/=" & set "result=%"
set "ryujinx_zip=!result!"
if "!Debug!" EQU "1" (
...
cls
echo upgrading to ryujinx v!ryujinx_zip:~8,-12!
call :HelperDownload "!ryujinx_link!" "!ryujinx_zip!"
:MoveRyujinx
move "!ryujinx_zip!" ".\extra\!ryujinx_zip!"
:ExtractRyujinx
call :HelperExtract "!folder!\extra\!ryujinx_zip!" "!folder!\temp\"
:CopyRyujinx
...
:e
cls
title Portable Ryujinx Launcher - Helper Edition - Text-Reader Update Check
cls
...
echo ================================================== >> !license!
cls
title Portable Ryujinx Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Ryujinx Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Ryujinx Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Ryujinx Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Ryujinx Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Ryujinx Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver

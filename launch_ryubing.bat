...
:Menu
cls
title Portable Ryubing Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall ryubing [will remove ryubing entirely]
echo 2. launch ryubing [launches ryubing]
echo 3. reset ryubing [will remove everything ryubing except the binary]
echo 4. uninstall ryubing [tired of constant emulator rebrands?]
...
:ReinstallRyubing
cls
call :UninstallRyubing
call :UpgradeRyubing
exit /b 2

:2
:LaunchRyubing
if not exist ".\bin\ryubing\Ryujinx.exe" set "nag=PLEASE INSTALL RYUBING FIRST" & exit /b 2
title DO NOT CLOSE
set "path=!PATH!;!folder!\dll\64\;"
cls
echo RYUBING IS RUNNING
pushd .\bin\ryubing\
start Ryujinx.exe
popd
exit
...
timeout -t 5
if exist .\bin\ryubing\portable\ rmdir /s /q .\bin\ryubing\portable\
exit /b 2
...
taskkill /f /im Ryujinx.exe
timeout -t 5
for /d %%i in (".\bin\ryubing\*") do if /i not "%%i"==".\bin\ryubing\portable" if exist "%%i" rmdir /s /q "%%i"
if exist .\bin\ryubing\*.* echo y | del .\bin\ryubing\*.* >nul
if exist .\extra\ryubing-*-win_x64.zip del .\extra\ryubing-*-win_x64.zip >nul
exit /b 2
...
cls
title Portable Ryubing Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Ryubing Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Ryubing Launcher - Helper Edition - Download Suite
...
title Portable Ryubing Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo pushd .\bin\ryubing\>>!quick_launcher!
...
:ExtractRyubing
call :HelperExtract "!folder!\extra\ryubing.zip" "!folder!\temp\"
:CopyRyubing
xcopy ".\temp\publish\*" ".\bin\ryubing\" /e /i /y
if exist .\temp\ rmdir /s /q .\temp\
if not exist .\bin\ryubing\portable\ mkdir .\bin\ryubing\portable\
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\ryubing.zip")
exit /b 2

:e
cls
title Portable Ryubing Launcher - Helper Edition - Text-Reader Update Check
cls
...
:f
cls
title Portable Ryubing Launcher - Helper Edition - Importing Ryujinx Data
set nag="Done Migrating Data From Ryujinx To Ryubing"
taskkill /f /im Ryujinx.Ava.exe
taskkill /f /im Ryujinx.exe
rmdir /s /q .\bin\ryubing\portable\
xcopy .\bin\ryujinx\portable\* .\bin\ryubing\portable\ /E /I /Y
rmdir /s /q .\bin\ryujinx\portable\
exit /b 2
...
if not exist ".\bin\ryubing\Ryujinx.exe" set nag=RYUBING IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Ryubing Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Ryubing Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Ryubing Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Ryubing Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Ryubing Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Ryubing Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver
...
:v2UpgradeCheck
if not exist .\bin\ryubing\ mkdir .\bin\ryubing\
if exist .\data\Users\MarioMasta64\AppData\Roaming\Ryubing\ xcopy .\data\Users\MarioMasta64\AppData\Roaming\Ryubing\* .\bin\ryubing\portable\ /e /i /y
if exist .\data\Users\MarioMasta64\AppData\Roaming\Ryubing\ rmdir /s /q .\data\Users\MarioMasta64\AppData\Roaming\Ryubing\
exit /b 2

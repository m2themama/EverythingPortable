...
:Menu
cls
title Portable Guilded Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall guilded [will remove guilded entirely]
echo 2. launch guilded [launches guilded]
echo 3. reset guilded [will remove everything guilded except the binary]
echo 4. uninstall guilded [overwhelmed by how many options there are?]
...
echo d. check for new guilded version [automatically check for a new version]
...
:ReinstallGuilded
cls
call :UninstallGuilded
call :UpgradeGuilded
exit /b 2

:2
:LaunchGuilded
if not exist ".\bin\guilded\Guilded.exe" set "nag=PLEASE INSTALL GUILDED FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo GUILDED IS RUNNING
start .\bin\guilded\Guilded.exe
exit
...
:ResetGuilded
cls
taskkill /f /im Guilded.exe
if exist .\data\Users\MarioMasta64\AppData\Roaming\Guilded\ rmdir /s /q .\data\Users\MarioMasta64\AppData\Roaming\Guilded\
exit /b 2
...
cls
taskkill /f /im Guilded.exe
if exist .\bin\guilded\ rmdir /s /q .\bin\guilded\
if exist .\extra\Guilded-Win.exe del .\extra\Guilded-Win.exe >nul
pause
exit /b 2
...
cls
title Portable Guilded Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Guilded Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Guilded Launcher - Helper Edition - Download Suite
...
title Portable Guilded Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo start .\bin\guilded\Guilded.exe>>!quick_launcher!
...
call :HelperDownload "https://www.guilded.gg/downloads/Guilded-Win.exe" "Guilded-Win.exe"
:MoveGuilded
move Guilded-Win.exe .\extra\Guilded-Win.exe
:ExtractGuilded
call :HelperExtract7Zip "!folder!\extra\Guilded-Win.exe" "!folder!\temp\"
call :HelperExtract7Zip "!folder!\temp\$PLUGINSDIR\app-64.7z" "!folder!\bin\guilded\"
if exist .\temp\ rmdir /s /q .\temp\
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\Guilded-Win.exe")
exit /b 2

:e
title Portable Guilded Launcher - Helper Edition - Text-Reader Update Check
cls
...
if not exist ".\bin\guilded\Guilded.exe" set nag=GUILDED IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Guilded Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Guilded Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Guilded Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Guilded Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Guilded Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Guilded Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver

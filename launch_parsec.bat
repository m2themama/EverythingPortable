...
:Menu
cls
title Portable Parsec Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall parsec [will remove parsec entirely]
echo 2. launch parsec [launches parsec]
echo 3. reset parsec [will remove everything parsec except the binary]
echo 4. uninstall parsec [do people keep thinking youre trying to scam them?]
...
echo d. check for new parsec version [automatically check for a new version]
...
:ReinstallParsec
cls
call :UninstallParsec
call :UpgradeParsec
exit /b 2

:2
:LaunchParsec
if not exist ".\bin\parsec\parsecd.exe" set "nag=PLEASE INSTALL PARSEC FIRST" & exit /b 2
title DO NOT CLOSE
cls
...
if exist .\data\Users\MarioMasta64\AppData\Roaming\Parsec\ rmdir /s /q .\data\Users\MarioMasta64\AppData\Roaming\Parsec\
exit /b 2
...
cls
title Portable Parsec Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Parsec Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Parsec Launcher - Helper Edition - Download Suite
...
title Portable Parsec Launcher - Helper Edition - Quicklauncher Writer
...
echo cls>>!quick_launcher!
echo pushd .\bin\parsec\>>!quick_launcher!
echo start parsecd.exe>>!quick_launcher!
...
:e
title Portable Parsec Launcher - Helper Edition - Text-Reader Update Check
cls
...
if not exist ".\bin\parsec\parsecd.exe" set nag=PARSEC IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Parsec Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Parsec Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Parsec Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Parsec Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Parsec Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Parsec Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver

...
:Menu
cls
title Portable Opera Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall opera [will remove opera entirely]
echo 2. launch opera [launches opera]
echo 3. reset opera [will remove everything opera except the binary]
echo 4. uninstall opera [not a fan of the new management?]
...
echo d. check for new opera version [automatically check for a new version]
...
cls
title Portable Opera Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Opera Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Opera Launcher - Helper Edition - Download Suite
...
title Portable Opera Launcher - Helper Edition - Quicklauncher Writer
...
:e
title Portable Opera Launcher - Helper Edition - Text-Reader Update Check
cls
...
if not exist ".\bin\opera\launcher.exe" set nag=OPERA IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Opera Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Opera Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Opera Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Opera Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Opera Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Opera Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver

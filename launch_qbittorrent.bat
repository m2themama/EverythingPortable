...
:2
:LaunchqBittorrent
if not exist ".\bin\qbittorrent\qBittorrent.exe" set "nag=PLEASE INSTALL QBITTORRENT FIRST" & exit /b 2
title DO NOT CLOSE
cls
...
if exist .\extra\qbittorrent_*.exe del .\extra\qbittorrent_*.exe >nul
exit /b 2
...
echo cls>>!quick_launcher!
echo start .\bin\qbittorrent\qbittorrent.exe>>!quick_launcher!
...
if exist .\bin\qbittorrent\$PLUGINSDIR\ rmdir /s /q .\bin\qbittorrent\$PLUGINSDIR\
if exist .\bin\qbittorrent\uninst.exe del .\bin\qBittorrent\uninst.exe >nul
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\!qbittorrent_exe!")
exit /b 2

...
:Menu
cls
title Portable Element Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall element [will remove element entirely]
echo 2. launch element [launches element]
echo 3. reset element [will remove everything element except the binary]
echo 4. uninstall element [having to reset your forgotten keys too much?]
...
echo d. check for new element version [automatically check for a new version]
echo e. install text-reader [update if had]
echo.
echo f. download azahar emulator [alternative to element]
echo.
...
if exist .\data\Users\MarioMasta64\AppData\Roaming\element\ rmdir /s /q .\data\Users\MarioMasta64\AppData\Roaming\element\
exit /b 2
...
cls
taskkill /f /im element.exe
if exist .\.\bin\element\ rmdir /s /q .\.\bin\element\
if exist .\extra\element_install.exe del .\extra\element_install.exe >nul
exit /b 2
...
cls
title Portable Element Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Element Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Element Launcher - Helper Edition - Download Suite
...
title Portable Element Launcher - Helper Edition - Quicklauncher Writer
...
cls
:UpgradeElement
title Portable Element Launcher - Helper Edition - Element Update Check
if exist "Element Setup.exe" del "Element Setup.exe" >nul
call :HelperDownload "https://packages.element.io/desktop/install/win32/x64/Element Setup.exe" "Element Setup.exe"
:ExtractElement
call :HelperExtract7Zip "!folder!\extra\Element Setup.exe" "!folder!\temp\"
:ExtractElementNupkg
for %%d in ("!folder!\temp\element*.nupkg") do set "element=%%d"
call :HelperExtract7Zip "!element!" "!folder!\temp\"
:MoveElementFiles
...
:e
cls
title Portable Element Launcher - Helper Edition - Text-Reader Update Check
cls
...
echo ================================================== >> !license!
cls
title Portable Element Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Element Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Element Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Element Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Element Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Element Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver

...
:Menu
cls
title Portable NotePad++ Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall notepad++ [will remove notepad++ entirely]
echo 2. launch notepad++ [launches notepad++]
echo 3. reset notepad++ [will remove everything notepad++ except the binary]
echo 4. uninstall notepad++ [?]
...
echo d. check for new notepad++ version [automatically check for a new version]
...
:2
:LaunchNotePad++
if not exist ".\bin\notepad++\notepad++.exe" set "nag=PLEASE INSTALL NOTEPAD++ FIRST" & exit /b 2
title DO NOT CLOSE
cls
...
cls
title Portable NotePad++ Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable NotePad++ Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable NotePad++ Launcher - Helper Edition - Download Suite
...
title Portable NotePad++ Launcher - Helper Edition - Quicklauncher Writer
...
cls
:UpgradeNotePad++
title Portable NotePad++ Launcher - Helper Edition - NotePad++ Update Check
if exist index.html del index.html >nul
call :HelperDownload "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/latest/" "index.html"
set counter=0
:UpgradeSearchLoop
set /a counter+=1
...
cls
echo upgrading to notepad++ v!notepad++_7z:~4,-12!
call :HelperDownload "!notepad++_link!" "!notepad++_7z!"
:MoveNotePad++
...
:e
title Portable NotePad++ Launcher - Helper Edition - Text-Reader Update Check
cls
...
:f
cls
for %%A in (.\bin\notepad++\config\notepad++-studio\basic\scenes\*.json) do (
  set "A=%%A"
...
:g
cls
title Portable NotePad++ Launcher - Helper Edition - Streamlabs Import
xcopy ".\data\Users\MarioMasta64\AppData\Roaming\slnotepad++-plugins\*" ".\bin\notepad++\" /e /i /y
xcopy ".\data\Users\MarioMasta64\AppData\Roaming\slnotepad++-client\basic\*" ".\bin\notepad++\config\notepad++-studio\basic\" /e /i /y
xcopy ".\data\Users\MarioMasta64\AppData\Roaming\slnotepad++-client\plugin_config\*" ".\bin\notepad++\config\notepad++-studio\plugin_config\" /e /i /y
xcopy ".\data\Users\MarioMasta64\AppData\Roaming\slnotepad++-client\profiler_data\*" ".\bin\notepad++\config\notepad++-studio\profiler_data\" /e /i /y
xcopy ".\data\Users\MarioMasta64\AppData\Roaming\slnotepad++-client\SceneCollections\*" ".\bin\notepad++\config\notepad++-studio\SceneCollections\" /e /i /y
xcopy ".\data\Users\MarioMasta64\AppData\Roaming\slnotepad++-client\Media\*" ".\bin\notepad++\config\notepad++-studio\Media\" /e /i /y
xcopy ".\data\Users\MarioMasta64\AppData\Roaming\slnotepad++-client\Session Storage\*" ".\bin\notepad++\config\notepad++-studio\Session Storage\" /e /i /y
xcopy ".\data\Users\MarioMasta64\AppData\Roaming\slnotepad++-client\global.ini" ".\bin\notepad++\config\notepad++-studio\" /e /i /y
pause
exit /b 2
...
if not exist ".\bin\notepad++" set nag=NotePad++ IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable NotePad++ Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable NotePad++ Launcher - Helper Edition - Latest Build :D
...
:PreviewBuild
cls
title Portable NotePad++ Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable NotePad++ Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver

...
:Menu
cls
title Portable Yuzu Launcher - Helper Edition - Main Menu
echo !NAG!
set nag="Selection Time!"
echo 1. reinstall yuzu [will remove yuzu entirely]
echo 2. launch yuzu [launches yuzu]
echo 3. reset yuzu [will remove everything yuzu except the binary]
echo 4. uninstall yuzu [pc too underpowered for yuzu?]
...
:2
:LaunchYuzu
if not exist ".\data\Users\MarioMasta64\AppData\Local\yuzu\yuzu-windows-msvc\yuzu.exe" set "nag=PLEASE INSTALL YUZU FIRST" & exit /b 2
title DO NOT CLOSE
set "path=!PATH!;!folder!\dll\64\;"
cls
echo YUZU IS RUNNING
start .\data\Users\MarioMasta64\AppData\Local\yuzu\yuzu-windows-msvc\yuzu.exe
exit
...
if exist .\data\Users\MarioMasta64\AppData\Roaming\yuzu\ rmdir /s /q .\data\Users\MarioMasta64\AppData\Roaming\yuzu\
exit /b 2
...
cls
taskkill /f /im yuzu.exe
if exist .\data\Users\MarioMasta64\AppData\Local\yuzu\ rmdir /s /q .\data\Users\MarioMasta64\AppData\Local\yuzu\
if exist .\extra\yuzu_install.exe del .\extra\yuzu_install.exe >nul
exit /b 2
...
cls
title Portable Yuzu Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Yuzu Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Yuzu Launcher - Helper Edition - Download Suite
...
title Portable Yuzu Launcher - Helper Edition - Quicklauncher Writer
...
:e
cls
title Portable Yuzu Launcher - Helper Edition - Text-Reader Update Check
cls
...
echo ================================================== >> !license!
cls
title Portable Yuzu Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Yuzu Launcher - Helper Edition - Latest Build :D
...
:PreviewBuild
cls
title Portable Yuzu Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Yuzu Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver

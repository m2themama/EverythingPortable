...
:Menu
cls
title Portable Citra Launcher - Helper Edition - Main Menu
echo !NAG!
...
:2
:LaunchCitra
if not exist ".\bin\citra\citra-qt.exe" set "nag=PLEASE INSTALL CITRA FIRST" & exit /b 2
title DO NOT CLOSE
...
if exist .\extra\*citra*.7z del .\extra\*citra*.7z >nul
exit /b 2
...
:LatestBuild
cls
title Portable Citra Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Citra Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:PreviewBuild
cls
title Portable Citra Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Citra Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver

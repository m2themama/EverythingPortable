...
:Menu
cls
title Portable Dolphin Launcher - Helper Edition - Main Menu
echo !NAG!
...
:ReinstallDolphin
cls
call :UninstallDolphin
call :UpgradeDolphin
exit /b 2

:2
:LaunchDolphin
if not exist ".\bin\dolphin\dolphin.exe" set "nag=PLEASE INSTALL DOLPHIN FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo DOLPHIN IS RUNNING
...
cls
title Portable Dolphin Launcher - Helper Edition - Checking For Update
...
:a
:DLLDownloaderCheck
cls & title Portable Dolphin Launcher - Helper Edition - Download Dll Downloader
...
:b
:PortableEverything
cls & title Portable Dolphin Launcher - Helper Edition - Download Suite
...
title Portable Dolphin Launcher - Helper Edition - Quicklauncher Writer
...
echo start .\bin\dolphin\dolphin.exe -u "%%folder%%\data\dolphin">>!quick_launcher!
...
call :HelperDownload "https://dl-mirror.dolphin-emu.org/5.0/dolphin-x64-5.0.exe" "dolphin-x64-5.0.exe"
:MoveDolphin
move dolphin-x64-5.0.exe .\extra\dolphin-x64-5.0.exe
:ExtractDolphin
call :HelperExtract7Zip "!folder!\extra\dolphin-x64-5.0.exe" "!folder!\bin\dolphin\"
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\dolphin-x64-5.0.exe")
exit /b 2

:e
title Portable Dolphin Launcher - Helper Edition - Text-Reader Update Check
cls
...
if not exist ".\bin\dolphin\dolphin.exe" set nag=DOLPHIN IS NOT INSTALLED CHOOSE "D"
exit /b 2
...
echo ================================================== >> !license!
cls
title Portable Dolphin Launcher - Helper Edition - About
...
:LatestBuild
cls
title Portable Dolphin Launcher - Helper Edition - Latest Build :D
...
:NewUpdate
cls
title Portable Dolphin Launcher - Helper Edition - Old Build D:
if "!NoPrompt!" NEQ "1" (
  cls
  echo !NAG!
  set nag="Selection Time!"
...
:UpdateNow
cls & title Portable Dolphin Launcher - Helper Edition - Updating Launcher
...
:PreviewBuild
cls
title Portable Dolphin Launcher - Helper Edition - Test Build :0
...
:Cmd
cls
title Portable Dolphin Launcher - Helper Edition - Command Prompt - By MarioMasta64
ver

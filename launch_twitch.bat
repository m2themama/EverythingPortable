...
:2
:LaunchTwitch
if not exist ".\data\Users\MarioMasta64\AppData\Roaming\Twitch\Bin\twitch.exe" set "nag=PLEASE INSTALL TWITCH FIRST" & exit /b 2
title DO NOT CLOSE
cls
echo TWITCH IS RUNNING
start .\data\Users\MarioMasta64\AppData\Roaming\Twitch\Bin\twitch.exe
exit
...
echo cls>>!quick_launcher!
echo start .\data\Users\MarioMasta64\AppData\Roaming\Twitch\Bin\twitch.exe>>!quick_launcher!
...
:NullExtra
if "!NullExtra!" EQU "1" ( echo.>".\extra\!twitch!")
exit /b 2
